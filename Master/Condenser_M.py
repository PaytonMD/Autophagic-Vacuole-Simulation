# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 08:11:12 2021

@author: Temp
"""

print("This script condenses PIF files into fewer lines, minimizing the file size.")
def main():
    ...
    print("Enter input piff file, including file path.")
    inputName = input()
